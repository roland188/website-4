...
<template>
    <view class="content">
        ...
        <Header :showTop="showDownload"></Header>
        <!-- 易记域名 -->
  ...
  methods: {
    ...
    getadd() {
      ...
      let hotList = {
        name: 'Game Hot',
        id: 0,
        menuIconApp: require("@/static/image/indexImg/icon_hot.svg"),
        menuIconActiveApp: require("@/static/image/indexImg/icon_hot.svg"),
    ...
    //                                     that.$store.commit("update", "前往更新");
    //                                     that.modeldata.title = "发现新版本V" + item.newVersion;
    ...
    //                                             }
    //                                         }
    //                                     } else if (item.versionType === 3 && models.platform === "android") {
    //                                         if (item.versionCode > code) {
    //                                             that.$store.commit("update", "立即更新");
    //                                             that.modeldata.title = "发现新版本V" + item.newVersion;
    //                                             that.modeldata.content = item.updateDescription;
