        ...
        <view class="leftNone">
          ...
          <view class="leftBottom moneyTop">
            <view class="money indexMoneyColor">
              <text class="textM">{{ dataJson.balance || "0.00" }}</text>
            </view>
          </view>
        </view>
      </view>
    ...
    .usertitle {
      ...
      .login-wrap {
        ...
        .loginBtn {
          color: #000;
		  border-radius: 18px;
		  background: linear-gradient(180deg, #FEEE8F 1.62%, #FFD600 42.05%, #FFD600 88.54%);
		  box-shadow: 0px -2px 29px 0px #FFF inset;
        }
        ...
        .regBtn {
          ...
          color: #000;
		  border-radius: 18px;
		  background: linear-gradient(180deg, #FFDED2 1.62%, #FFF5F1 31.99%, #FFC3AD 100%);
        }
      }
