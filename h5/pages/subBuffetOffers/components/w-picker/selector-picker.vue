		...
		<picker-view class="d-picker-view" :indicator-style="itemHeight" :value="pickVal" @change="handlerChange">
			<picker-view-column>
				<view class="w-picker-item" v-for="(item,index) in range" :key="index">
					<view class="w-picker-text-row">
						<image class="w-picker-img-l" :src="$config.getImgUrl(item.imgUrl)" mode="" v-if="isImg"></image>
						<text class="w-picker-text">{{item[nodeKey]}}</text>
					</view>
				</view>
			</picker-view-column>
		</picker-view>
