<template>
    <div>
        ...
        <!-- <div class="fwDownload" v-if="projectImgUrl == 'sovip'">
            <div class="icon hotline" @click="jump('hotline')"></div>
        </div> -->
        <el-popover popper-class="appDown"
            v-if="projectImgUrl == 'sovip'"
                    placement="left-start"
                    width="128"
                    trigger="hover">
            <div class="qrCode">
                <div class="qr iosQrCode">
                    <img loading="lazy" class="avater"
                        v-lazy="require('../../../../assets/image/dze/float_zalo.jpg')" />
                </div>
            </div>
            <div slot="reference"
                 class="fwDownload" >
        ...
        <div class="fwDownload"
            v-if="['sovip','betc88','wynn','dola789'].includes(projectImgUrl)">
