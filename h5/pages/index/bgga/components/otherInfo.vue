...
<template>
    <view class="other-info">
        <view class="app">
            <view class="content">
                <view class="title">{{$t('下载软件')}}</view>
                <view class="app_items">
                    <view class="android" @click="dowApp">
                        <image mode="heightFix"  :src="require('@/static/image/indexImg/app_android.png')"></image>
                        <text>{{$t('说明')}}</text>
                    </view>
                    <view class="ios" @click="dowApp">
                        <image mode="heightFix" :src="require('@/static/image/indexImg/app_ios.png')"></image>
                        <text>{{$t('说明')}}</text>
                    </view>
                </view>
            </view>
            <view class="bg-wrapper">
                <image class="img" mode="heightFix" :src="require('@/static/image/indexImg/app_img.png')"></image>
            </view>
        </view>
		<scrollSwiper  />
		...
		<home-foot />
         <!-- <view class="partner-okvip">
            <view>
                <view class="payment-title">Đối Tác Chính Thức</view>
...
<script>
	import scrollSwiper from './scrollSwiper.vue'
	import homeFoot from './homeFoot.vue'
export default {
	components:{scrollSwiper,homeFoot},
    data() {
        return {
