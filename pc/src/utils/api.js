...
let dzr = {
    ...
    getThematicActivitiesListByApp: '/longm/api/v1/thematicActivities/getThematicActivitiesListByApp', //获取专题活动列表
    getThematicActivitiesByApp: '/longm/api/v1/thematicActivities/getThematicActivitiesByApp', //app端专题活动详情
    getListFloatingWindows: '/longm/api/v1/settingsEntryWindows/listFloatingWindows', // 获取浮悬框列表
...
const api = {
    ...
    getWaterBallList: '/longm/api/v1/thematicActivities/getWaterBallList?clientItem=', //请求活动打码列表
    getReceives: '/longm/api/v1/thematicActivities/receive?thematicActivitiesId=', ///自助优惠领取
    getSbwReceive: '/longm/api/v1/thematicActivities/receive?thematicActivitiesId=', ///自助优惠领取
    ...
    getReceiveActivities: '/longm/api/v1/thematicActivities/receive?thematicActivitiesId=', //自助优惠领取
    ...
    getAgentCommissionPlan: '/longm/api/v1/agentCommissionPlan/getAgentCommissionPlan',
    ...
    exchangeRecordList: '/mall/api/v1/shoppingExchangeRecord/listShoppingExchangeRecord',//兑换记录列表
