<template>
  <view class="uni-calendar" @mouseleave="leaveCale">
    ...
    >
      <view class="uni-calendar__header">
        ...
        >
          <text class="uni-calendar__header-text">{{
            (nowDate.year || "") + $t('年') + ' ' + (nowDate.month || "") + $t('月')
          }}</text>
        </picker>
        <view
          v-if="right"
      ...
      >
        <text class="uni-date-changed--time-date">{{
          tempSingleDate ? tempSingleDate : $t('选择日期')
        }}</text>
        <time-picker
          type="time"
      ...
      >
        <view class="uni-date-changed--time-start">
          <text class="uni-date-changed--time-date">{{
            tempRange.before ? tempRange.before : $t('开始日期')
          }}</text>
          <time-picker
            type="time"
            :start="reactStartTime"
        ...
        <view class="uni-date-changed--time-end">
          <text class="uni-date-changed--time-date">{{
            tempRange.after ? tempRange.after : $t('结束日期')
          }}</text>
          <time-picker
            type="time"
            :end="reactEndTime"
      ...
      <view
        v-if="!insert"
        class="uni-date-changed uni-calendar__header"
        @click="confirm"
      >
        ...
        <view class="uni-calendar__header-btn-box">
          <text class="uni-calendar__button-text uni-calendar--fixed-width">{{
            $t("确定")
          }}</text>
        </view>
      </view>
