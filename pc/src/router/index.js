...
const routers = [{
     ...
     */
    {
        ...
        name: "pwdforget",
        component: () =>
            import ('@/pages/user/pwdforget') //忘记密码
    },
    {
        path: '/bankRecharge',
        name: 'bankRecharge',
