<template>
    <div class="play">
        <div class="playList">
            ...
            <!-- 顶部背景图片 -->
            <div class="bg">
                <img loading="lazy" class="img" v-lazy="$config.getLocaleImg('listbg4','jpg')" alt="">
            </div>
            <!-- 游戏二级列表 -->
            ...
            <div class="showPlayList">
                <ul style="overflow:hidden;margin-top:15px;">
                    <li class="sportItem"  v-for="(item1,ind) in curMenuList" :key='ind' @click="getToken(item1,2)">
                        <div class="img-wrap">
                            <img loading="lazy" class="img" v-lazy="sportList[ind%8].img" />
                            <img loading="lazy" class="imgs" v-lazy="sportList[ind%8].imgs" />
                        </div>
                        <div  class="sportName">{{item1.name}}</div>
                        <div class="sportIntro">
                            {{sportList[ind%4].intro}}
                        </div>
                    </li>
                </ul>
...
export default {
    ...
    data(){
        return {
            ...
            sportList:[
                {
                    img:require('@/assets/image/gameImg/sport1.png'),
                    imgs:require('@/assets/image/gameImg/sport1_hover.png'),
                    intro:this.$t('丰富多元的赛事投注，即时查询现状资讯')
                },{
                    img:require('@/assets/image/gameImg/sport2.png'),
                    imgs:require('@/assets/image/gameImg/sport2_hover.png'),
                    intro:this.$t('多元的体育项目，独家的赛事分析')
                },{
                    img:require('@/assets/image/gameImg/sport3.png'),
                    imgs:require('@/assets/image/gameImg/sport3_hover.png'),
                    intro:this.$t('独创虚拟体育娱乐赛事，盘口界面清晰，方便串关')
                },{
                    img:require('@/assets/image/gameImg/sport4.png'),
                    imgs:require('@/assets/image/gameImg/sport4_hover.png'),
                    intro:this.$t('提供最准确即时的赛事结果与线上投注服务')
                },
                {
                    img:require('@/assets/image/gameImg/sport5.png'),
                    imgs:require('@/assets/image/gameImg/sport5_hover.png'),
                    intro:this.$t('丰富多元的赛事投注，即时查询现状资讯')
                },{
                    img:require('@/assets/image/gameImg/sport6.png'),
                    imgs:require('@/assets/image/gameImg/sport6_hover.png'),
                    intro:this.$t('多元的体育项目，独家的赛事分析')
                },{
                    img:require('@/assets/image/gameImg/sport7.png'),
                    imgs:require('@/assets/image/gameImg/sport7_hover.png'),
                    intro:this.$t('独创虚拟体育娱乐赛事，盘口界面清晰，方便串关')
                },{
                    img:require('@/assets/image/gameImg/sport8.png'),
                    imgs:require('@/assets/image/gameImg/sport8_hover.png'),
                    intro:this.$t('提供最准确即时的赛事结果与线上投注服务')
                },
            ],
            openDialog:false,
